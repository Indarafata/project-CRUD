		...
		<div class="container-fluid">
			<div class="navbar-menu d-flex align-items-center justify-content-between w-100">
						...
						<ul class="navbar-nav">
							<li class="nav-item dropdown">
								...
								<div class="dropdown-menu bg-dark" aria-labelledby="navbarDropdownMenuLink" id="navmenu">
									<a class="dropdown-item bg bg-dark" href="laptop sebelum login.html" style="color:white">Overview</a>
									<a class="dropdown-item bg bg-dark" href="laptop 2 in 1 sebelum login.html" style="color:white">Profile User</a>
									<a class="dropdown-item bg bg-dark" href="monitor sebelum login.html" style="color:white">Data MAHASISWA</a>
									<a class="dropdown-item bg bg-dark" href="printer sebelum login.html" style="color:white">Data Tugas</a>
								</div>
							</li>
						</ul>
					</div>
				...
				<div class="right-menu d-flex flex-row-reverse align-items-center">
					<a class="btn"  href="lsign up.html" id="navmenu">Logout</a>
					<a class="btn"  href="login3.html" id="navmenu">Profile</a>
        ...
        <table border="1" class="fl-table">
            ...
            if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_array($result)){
                    ...
                    echo "<td> <a href='profilesiswa.php?ID=$row[ID]' style='color: black; text-decoration:none'>Edit Data</a> | <a href='siswa_delete.php?ID=$row[ID]' style='color: black; text-decoration:none'>Hapus Data</a> </td>";
                    echo "</tr>";
                }
            }
            else
